                    ...
                    @foreach ($borders as $index => $border)
                        <tr class="border-b">
                            ...
                            <td class="p-2" style="white-space: nowrap;">
                                <a href="{{ route('borders.edit', $border->id) }}" class="btn btn-primary" style="width: 50px; display: inline-block;">Edit</a>
                                <form action="{{ route('borders.destroy', $border->id) }}" method="post" class="inline" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
