            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                    ...
                    <li class="menu nav-item">
                        <button type="button" class="nav-link group"
                            ...
                            <div class="flex items-center">
                                ...
                                <span
                                    class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Location</span>
                            </div>
                            <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'dashboard' }">
                    ...
                    <li class="menu nav-item">
                        ...
                        <ul x-cloak x-show="activeDropdown === 'customer'" x-collapse class="sub-menu text-gray-500">
                            <li>
                    ...
                    <li class="menu nav-item">
                        <button type="button" class="nav-link group"
                            :class="{ 'active': activeDropdown === 'vehicle' }"
                            @click="activeDropdown === 'receiver' ? activeDropdown = null : activeDropdown = 'receiver'">
                            <div class="flex items-center">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="group-hover:!text-primary shrink-0">
                                    <path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <span
                                    class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Receiver</span>
                            </div>
                            <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'receiver' }">
                        ...
                        <ul x-cloak x-show="activeDropdown === 'receiver'" x-collapse class="sub-menu text-gray-500">
                            <li>
                                <a href="/clients">Receiver</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu nav-item">
                        <button type="button" class="nav-link group"
                            :class="{ 'active': activeDropdown === 'vehicle' }"
                            @click="activeDropdown === 'vehicle' ? activeDropdown = null : activeDropdown = 'vehicle'">
                            <div class="flex items-center">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="group-hover:!text-primary shrink-0">
                                    <path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <span
                                    class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Vehicle</span>
                            </div>
                            <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'vehicle' }">
